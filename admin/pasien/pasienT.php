                    ...
                    <div class="page-title">
                        ...
                        <div class="title_right mt-5">
                            <div class="text-right mt-3 mb-3">
                                <!-- <a href='#' data-id="<?php //echo $_row['id']; ?>"
                                    class="btn btn-primary btn-sm tambah2 me-5">
                                            ...
                                            <div
                                                ...
                                                <table id="datatable-responsive" class=" dt-responsive nowrap"
                                                    ...
                                                    <thead>
                                                        ...
                                                        // $id = $_GET['id'];
                                                        //    }
                                                        // $sql = "SELECT * FROM pasienT WHERE id=$id";
                                                        $sql = "SELECT * FROM pasienT LEFT JOIN login ON pasienT.login_id = login.name WHERE  pasienT.poli2 = '{$_SESSION['level']}' ORDER BY pasienT.tanggal DESC";
                                                        ...
                                                        <tr class="text-left">
                                                            <th colspan="2" class="text-center">Ke Poli :
                                                                <?php echo $row['poli2']; ?>
                                                            </th>
                                                        </tr>
                                                        <tr class="mb-5">
                                                            <th colspan="4 " style="border: none;">
                                                                <a href="#" data-id=' <?php echo $row['name']; ?>'
                                                                    class="btn btn-primary btn-sm tambah3 me-5">
                                                                    <i class="fa fa-plus"
                                                    ...
                                                    <?php    
                                                        ...
                                                        Belum ada riwayat yang tidak tertangani</td></tr>';
                                                    } 
