            ...
            <div class="col-md-3 left_col" style="position:fixed;">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0">
                        <a href="index.php" class="site_title"><span>Dasboard Poli Umum</span></a>
                    </div>
                    ...
                    <div class="page-title">
                        ...
                        <div class="title_right mt-5">
                            <div class="text-right mt-3 mb-3">
                                <!-- <a href="cetak.php" data-id='/ echo $row['id']; ?>'
                                    class="btn btn-danger btn-sm tambah me-5">
                                            ...
                                            <div
                                                ...
                                                <table id="datatable-responsive" class=" dt-responsive nowrap"
                                                    ...
                                                    <thead>
                                                        ...
                                                        $sql = "SELECT * FROM pasien LEFT JOIN login ON pasien.login_id = login.id WHERE pasien.login_id = $id ORDER BY pasien.tanggal DESC";
