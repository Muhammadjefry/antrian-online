...
<div class="con">
    <div class="bot11">
        <div class="bot2">
            <h1>Our Services </h1>
            <h6><a href="services.php">Services |</a><span><a href="index.php"> Home</a></span></h6>
        </div>
    </div>
</div>
<div class="content">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" id="svg7">
    ...
    <div class="services2">
        <div class="img">
            <img src="assets/img/klinik_umum.png" alt="img">
            <h5>UMUM</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_gigi.png" alt="img">
            <h5>GIGI</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_gizi.png" alt="img">
            <h5>GIZI</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_kia.png" alt="img">
            <h5>KIA</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_oti.png" alt="img">
            <h5>BATRA</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_paru.png" alt="img">
            <h5>PARU</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_degeneratif.png" alt="img">
            <h5>LANSIA</h5>
        </div>
        <div class="img">
            <img src="assets/img/klinik_psikologi.png" alt="img">
            <h5>PSIKOLOGI</h5>
        </div>
    </div>
</div>
