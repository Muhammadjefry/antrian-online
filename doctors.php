...
<div class="con">
    <div class="bot111">
        <div class="bot2">
            <h1 class="text-warning">Our Doctors </h1>
            <h6><a href="doctors.php">Doctors |</a><span><a href="index.php"> Home</a></span></h6>
        </div>
    </div>
</div>
<div class="content">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" id="svg8">
        <path fill="#00a7a2" fill-opacity="1"
            d="M0,160L80,176C160,192,320,224,480,240C640,256,800,256,960,224C1120,192,1280,128,1360,96L1440,64L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z">
        </path>
    </svg>
    <!-- <div class="doctors1">
    ...
    <div class="doctors2">
        <div class="doc-img">
            <img src="assets/img/bang1.png" alt="">
            <div class="tul">
                <h5>Dr. Robert Wiliyam</h5>
                <p>Lorem ipsum dolor, sit.</p>
            </div>
        </div>
        <div class="doc-img">
            <img src="assets/img/bang3.png" alt="">
            <div class="tul">
                <h5>Dr. Natasya</h5>
                <p>Lorem ipsum dolor, sit.</p>
            </div>
        ...
        <div class="doc-img">
            <img src="assets/img/bang2.png" alt="">
            <div class="tul">
        ...
        <div class="doc-img">
            <img src="assets/img/bang4.png" alt="">
            <div class="tul">
                <h5>Dr. Elizabeth Olsen</h5>
                <p>Lorem ipsum dolor sit.</p>
            </div>
        </div>
    </div>
...
<!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/OhXBGC3mm74" title="You tube video player "
